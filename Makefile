...
INCLUDES	:=	include lib/libtesla/include lib/Atmosphere-libs/libstratosphere/source/dmnt
NO_ICON		:=  1
...
send : all
	@lftp -p $(IP_PORT) -e "put $(TARGET).ovl -o /switch/.overlays/0_$(APP_TITLE).ovl; exit" $(IP_ADDRESS)
